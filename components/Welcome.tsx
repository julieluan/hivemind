...
export function Welcome({ onStart }: { onStart: (initCapital: number) => void }) {
  ...
  const cards: Array<{ icon: string; iconBg: string; title: string; body: string }> = [
    ...
    },
    {
      icon: "4",
      iconBg: "bg-[var(--ink)]",
      title: "Trade. Beat them by day 32.",
      body: "Buy / Hold / Sell with USD or %. Live leaderboard vs you, Buy & Hold, and 7 agent books. End-game recap shows a full daily action heatmap and every deception.",
    },
  ];
